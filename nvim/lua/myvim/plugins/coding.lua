    ...
    opts = function()
      ...
      return {
        ...
        custom_textobjects = {
          ...
          f = ai.gen_spec.treesitter({ a = "@function.outer", i = "@function.inner" }, { use_nvim_treesitter = true }), -- function TODO: use_nvim_treesitter see mini.nvim #1864
